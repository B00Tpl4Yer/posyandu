    ...
    <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-7 gap-3 mx-auto font-medium">
            <a href="{{route('admin.lihat-hasil-status-gizi')}}" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <a href="{{route('admin.lihat-hasil-berat')}}" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <a href="{{route('admin.beri-resep-form')}}" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <a href="{{route('admin.kelola-artikel')}}" type="button" class="mb-1 bg-blue-600 border border-gray-800 dark:border-gray-400 rounded-full  inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-news w-8 h-8 mb-2 text-white  group-hover:text-blue-600 dark:group-hover:text-blue-500" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <button id="dropdownTopButton1" data-dropdown-toggle="dropdownTop1" data-dropdown-placement="top" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
             ...
             <!-- Dropdown menu -->
             <div id="dropdownTop1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-30 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownTopButton1">
                    <li>
                        <a href="{{route('admin.lihat-feedback')}}" class="block px-4 py-2 text-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">lihat feedback</a>
                    </li>
                    <li>
                        <a href="/bantuan" class="block px-4 py-2 text-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">petunjuk penggunaan</a>
                    </li>
