...
<div class="container">
    ...
    <div class="w-72 xl:w-full flex flex-col mt-28 mb-20 border border-gray-100 dark:border-gray-800 p-5 rounded-lg bg-white dark:bg-gray-700">
        <h1 class="text-center text-3xl font-medium text-black dark:text-white mb-5">hasil timbangan berat badan pasien</h1>
        @foreach($riwayatberatbadan as $riwayat)
        <div class="flow-root">
